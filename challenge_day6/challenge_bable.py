...
def ask_c1():
    ...
    def ask_c2():
        ...
        try:
            ...
            ask_c2()
        print(
            f"How many {country_1['code']} do you want to conver to {country_2['code']}?")

        def trans():
            try:
                money = format(float(input()), ',')
                ...
                print(
                    f"{country_1['code']} {money} is " + format_currency(value, country_2['code'], locale="ko_KR"))
            except:
                print("That wasn't a number")
                trans()
